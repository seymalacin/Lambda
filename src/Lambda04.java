...
public class Lambda04 {
   ...
   */
    ...
    public static int matBolumSayisi(List<Universite> unv){
        return (int) unv.
                stream().//skis sagaldim
                filter(t->t.getBolum().contains("mat")).//matematik boumu olan uni sectim
                count();//secien unv. sayisini aldim
    }
    ...
    public static OptionalInt ogrenciSayisi1050AzMinNotOrt(List<Universite>unv){
       return unv.
               stream().
